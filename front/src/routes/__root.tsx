...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ana Clara Nails — Agendamento de nail design" },
      { name: "description", content: "Catálogo de modelos de unha, agendamento online com sinal de 50% e acompanhamento do seu horário." },
      { name: "author", content: "Ana Clara Nails" },
      { property: "og:title", content: "Ana Clara Nails — Agendamento de nail design" },
      ...
      { name: "apple-mobile-web-app-title", content: "Ana Clara Nails" },
    ],
    links: [
      {
        rel: "stylesheet",
